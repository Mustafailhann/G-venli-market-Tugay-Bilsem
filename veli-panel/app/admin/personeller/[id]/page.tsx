                                    ...
                                    >
                                        <div className="flex justify-between items-start gap-2">
                                            ...
                                            <div className="flex items-center gap-1.5 flex-shrink-0">
                                                ...
                                                {!islem.isCancelled && (
                                                    <button
                                                        onClick={() => setCancelTarget({ type: 'islem', index: idx, label: islem.aciklama, tutar: islem.tutar, tip: islem.tip })}
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {islem.islemFotografi ? (
                                                        <button onClick={() => setSelectedPhoto({ path: islem.islemFotografi!, timestamp: islem.tarih.toDate().toLocaleString('tr-TR') })} className="p-1 text-blue-600 hover:bg-blue-100 rounded transition-colors" title="İşlem Fotoğrafı">📷</button>
                                                    ) : (
                                                        <button disabled className="p-1 text-gray-300 cursor-not-allowed" title="Bu işlem için fotoğraf kaydedilmemiş (Eski işlem)">📷</button>
                                                    )}
                                                </div>
                                                {islem.isCancelled && (
                                                    <span className="inline-block mt-1 text-xs font-semibold text-red-500 bg-red-50 px-1.5 py-0.5 rounded">İptal Edildi</span>
                                                )}
                                                    ...
                                                    <div className="mt-1 flex flex-wrap gap-1">
                                                        {islem.urunler.map((urunEntry, j) => {
                                                            const label = typeof urunEntry === 'object' && urunEntry !== null
                                                                ...
                                                                : String(urunEntry);
                                                            return (
                                                                <span key={j} className="text-xs bg-red-100 text-red-700 px-1.5 py-0.5 rounded">{label}</span>
                                                            );
                                                        })}
                                                    </div>
                                                )}
                                    ...
                                    >
                                        <div className="flex justify-between items-start gap-2">
                                            ...
                                            <div className="flex items-center gap-1.5 flex-shrink-0">
                                                ...
                                                {!ku.isCancelled && (
                                                    <button
                                                        onClick={() => setCancelTarget({ type: 'kart', index: idx, label: ku.aciklama, tutar: ku.tutar })}
                                                        className="p-1 rounded-lg text-gray-400 hover:text-red-600 hover:bg-red-50 transition-colors"
                                                        title="İptal Et"
                                                    >
                                                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
